...
class TelemetryHandler
{
  public:
    ...
    /**
     * @brief interface to call update telemetry for each of the telemetry
     * module
     *
     ...
     */
    virtual int
        updateTelemetry(const std::string& devicePath,
     ...
     * or absence of given namespace exception is thrown.
     */
    virtual std::vector<nv::shmem::SensorValue>
        getAllMrds(const std::string& mrdNamespace) = 0;
     ...
     */
    virtual std::vector<std::string> getMrdNamespaces()
    {
        return {};
    };
