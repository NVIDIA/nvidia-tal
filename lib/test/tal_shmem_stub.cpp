...
/*
 * Stub implementation of SharedMemModule for unit tests.
 * Replaces tal_shmem.cpp at link time; does NOT call any nv::shmem symbols
 * so the test binary has no runtime dependency on the shmem library.
 */
