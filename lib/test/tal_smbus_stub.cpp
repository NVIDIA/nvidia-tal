...
/*
 * Stub implementation of SmBusModule for unit tests.
 * Replaces tal_smbus.cpp at link time when ENABLE_SMBUS is defined.
 * No real SMBus device I/O is performed.
 */
